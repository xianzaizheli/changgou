...
public class SeckillGoodsServiceImpl implements SeckillGoodsService {
    ...
    @Override
    public SeckillGoods one(String key, String id) {
        return (SeckillGoods)redisTemplate.boundHashOps("Seckill_" + key).get(id);
    }

    @Override
    public List<SeckillGoods> list(String key) {
        return redisTemplate.boundHashOps("Seckill_"+key).values();
    }
