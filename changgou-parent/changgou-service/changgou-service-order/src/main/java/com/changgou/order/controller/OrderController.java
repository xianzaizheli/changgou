...
public class OrderController {
     ...
     */
    @GetMapping("/pay/suc")
    public Result updateStatus(String orderId, @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")Date datetime, String transactionid) {
        System.out.println(datetime);
        orderService.updateStatus(orderId,datetime,transactionid);
        return new Result(true , StatusCode.OK , "支付成功，修改订单中");
    }
    ...
    public Result deleteOrder(String orderId) {
        ...
        return new Result(true , StatusCode.OK , "支付失败，修改订单并回滚库存");
    }
